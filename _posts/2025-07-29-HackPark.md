...
# Resolution summary
- Navigated to side and found a login form that would be brute forced using hydra
...
Through some enumeration we can see that it is running blogengine 3.3.6.0
